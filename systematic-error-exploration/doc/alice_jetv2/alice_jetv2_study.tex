...
\begin{center}
    \begin{figure}
        ...
        % \caption{Second-order harmonic coefficient \vj~as function a of \ptjet{} for 0--5\% collision centrality. The error bars on the points represent statistical uncertainties, the open and shaded boxes indicate the shape and correlated uncertainties (as explained in Sec.~\ref{sec:24}). }
        \label{fig:data}
    \end{figure}
\end{center}
